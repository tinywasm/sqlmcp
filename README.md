...
The JSON Schema for each tool's `inputSchema` is generated by [`tinywasm/mcp`](https://github.com/tinywasm/mcp) from `Tool.Args`; **sqlmcp does not produce JSON Schema itself**.
